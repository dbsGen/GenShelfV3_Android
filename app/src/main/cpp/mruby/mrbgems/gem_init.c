...
void GENERATED_TMP_mrb_mruby_tempfile_gem_init(mrb_state *);
void GENERATED_TMP_mrb_mruby_tempfile_gem_final(mrb_state *);
void GENERATED_TMP_mrb_mruby_http_gem_init(mrb_state *);
void GENERATED_TMP_mrb_mruby_http_gem_final(mrb_state *);
