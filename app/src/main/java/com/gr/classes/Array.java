...
@NativeClass("gcore::_Array")
public class Array<T> extends Helper.GInstance implements Collection<T> {
    private static Helper.GClass<Array> _class;
    static {
        _class = Helper.find(Array.class);
    }
